    ...
    if input_method == "Upload Packaging Image":
        ...
        with col_p1:
            ...
            if st.button("🌾 Atta 1 kg (Exempt Pack)", use_container_width=True):
                demo_image_name = "media_1788711950650.png"
        with col_p2:
            if st.button("🍪 Biscuits 200 gm (Non-SI Unit)", use_container_width=True):
                demo_image_name = "media_1788703216192.jpg"
        ...
        if demo_image_name:
            sample_candidates = [
                ...
                os.path.join(r"C:\Users\DELL\.gemini\antigravity\brain\8d5a4dc9-3a33-4512-b625-4b3e317d6ac6\.user_uploaded", demo_image_name)
            ]
